return{
    ...
    guide={
        ...
        "首先填写bot的账号等基础配置",
        "请在port和port2处填写端口(任意空闲端口均可),id处填写QQ号,useGuide处填写是否开启配置文件中的注释(true为开启,false为关闭)",
        "owner处填主人,可以私发消息以更改一些内容,可不填",
        "autoRestart决定在消息发送失败时是否自动重启"
    },
    help=nil,
    config={
        ...
        {name="autoRestart",type={"java.lang.Boolean"},nullable=false},
