...
所有功能仅限控制台除聊天外均为英文输出时有效，暂时不支持BE服，无需外加插件/模组，含自动崩服自启功能
...
每日零点自动备份，如果服地图较大或者服务器存档不只有world一个文件夹，请使用禁用自动更新并使用另外的备份方式，备份存储于QBot根目录下的backups文件夹，按照服务器名称归类，备份时会删除10天前的备份
